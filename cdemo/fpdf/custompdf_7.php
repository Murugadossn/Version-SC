...
$this->Ln(12);
    ...
    $this->Cell(0,0,"CLASSES VI to VIII",0,1,'C');
    $this->Ln(6);
		$this->SetFont('Arial','B',14);	
			$this->Cell(91,6,"Session:",0,0,'R');
//			$this->Cell(10);
...
// 		mysql_select_db('newonli1_demodb1', $mysql);
		...
		$this->SetFont('Arial','',10);				
					...
					$this->Cell(15);	
		$this->SetFont('Arial','',10);			
					$this->MultiCell(100,6,$rows[6],B,L);			
					$this->Cell(75);
		$this->SetFont('Arial','',10);					
					$this->Cell(100,6,$rows[7],B,1,'L');	
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				...
				$data = array();
				$resultg1 = mysql_query("SELECT sequence_num,subject_name, round(FA1,2),round(FA2,2),round(SA1,2),round(FA1_FA2_SA1,2),
				round(FA3,2),round(FA4,2),round(SA2,2),round(FA3_FA4_SA2,2),round(FA1_FA2_FA3_FA4,2), round(SA1_SA2,2), round(Overall,2),
				Grade_Point,account_student_map_id,account_grade_id FROM cce_rc_section1_marks_det_v1 where  account_student_map_id = $accountstudentid");
				
				/* $resultg1 = mysql_query("SELECT sequence_num,subject_name,FA1,FA2,SA1,FA1_FA2_SA1,FA3,FA4,SA2,FA3_FA4_SA2,FA1_FA2_FA3_FA4,SA1_SA2,
				Overall,Grade_Point,account_student_map_id,account_grade_id FROM cce_rc_section1_marks_det_v1 
				where  account_student_map_id = $accountstudentid and sequence_num in ( '01', '02', '03', '04', '05', '06', '07','') ");
				*/
				while ($rows = mysql_fetch_array($resultg1)) {
					//$data = $rows;
...
$this->SetTextColor(0,0,0);							
			$this->Cell(12);
			$this->Cell(18,9,"Overall Grade: ",0,0,'L',false);
			$this->Cell(25);			
...
$this->SetFont('Arial','',10);	
		...
		function page3Title() {
			...
			// Background color
			// Title
			$this->Cell(80,0,"Part 2: Co-Scholastic Areas",0,0,'L', false);
		...
		$this->SetXY(20 , 35);
			...
			// Background color
			// Title
			$this->Cell(80,0,"2 (A): Life Skills",0,0,'L', false);
			$this->SetFont('Arial','',10);	
...
// 		mysql_select_db('newonli1_demodb1', $mysql);
				...
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('Self Awareness') ");
...
//gap
					...
					$this->SetFont('Arial','B',10);							
//Descriptor Heading
					$this->Write($descriptorFont, "Self Awareness:");
					$this->SetFont('Arial','',10);							
//Descriptor Text
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query(" select assessment_category_type, remarks, grade  from cce_rc_section_2A_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('Problem Solving') ");
				$rows = mysql_fetch_array($resultg1);
...
//gap
					...
					$this->SetFont('Arial','B',10);							
//Descriptor Heading
					$this->Write($descriptorFont, "Problem Solving: ");
					$this->SetFont('Arial','',10);							
//Descriptor Text
					$this->Write($descriptorFont, "$rows[1]");
					//        $this->SetLeftMargin();				
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query(" select assessment_category_type, remarks, grade  from cce_rc_section_2A_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('Decision Making') ");
				$rows = mysql_fetch_array($resultg1);
...
//gap
					...
					$this->SetFont('Arial','B',10);							
//Descriptor Heading
					$this->Write($descriptorFont, "Decision Making: ");
					$this->SetFont('Arial','',10);							
//Descriptor Text
					$this->Write($descriptorFont, "$rows[1]");
					//        $this->SetLeftMargin();				
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query(" select assessment_category_type, remarks, grade  from cce_rc_section_2A_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('Critical Thinking') ");
				$rows = mysql_fetch_array($resultg1);
				
				$this->SetFont('Arial','',10);					
//S.No
				$this->Cell(10,6,"04",0,0,'C',false);				
//gap
					$this->Cell(3,13);			
					$current_y =  $ystartpos ;  //52
					$current_x = $this->GetX();	
					...
					$this->SetFont('Arial','B',10);							
//Descriptor Heading
					$this->Write($descriptorFont, "Critical Thinking: ");
					$this->SetFont('Arial','',10);							
//Descriptor Text
					$this->Write($descriptorFont, "$rows[1]");
					//        $this->SetLeftMargin();				
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query(" select assessment_category_type, remarks, grade  from cce_rc_section_2A_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('Creative Thinking') ");
				$rows = mysql_fetch_array($resultg1);
				
				$this->SetFont('Arial','',10);					
//S.No
				$this->Cell(10,6,"05",0,0,'C',false);				
//gap
					$this->Cell(3,13);			
					$current_y =  $ystartpos ;  //52
					$current_x = $this->GetX();	
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query(" select assessment_category_type, remarks, grade  from cce_rc_section_2A_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('Interpersonal Relationships') ");
				$rows = mysql_fetch_array($resultg1);
				
				$this->SetFont('Arial','',10);					
//S.No
				$this->Cell(10,6,"06",0,0,'C',false);				
//gap
					$this->Cell(3,13);			
					$current_y =  $ystartpos ;  //52
					$current_x = $this->GetX();	
					...
					$this->SetFont('Arial','B',10);							
//Descriptor Heading
					$this->Write($descriptorFont, "Interpersonal Relationships: ");
					$this->SetFont('Arial','',10);							
//Descriptor Text
					$this->Write($descriptorFont, "$rows[1]");
					//        $this->SetLeftMargin();				
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query(" select assessment_category_type, remarks, grade  from cce_rc_section_2A_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('Effective Communication') ");
				$rows = mysql_fetch_array($resultg1);
				
				$this->SetFont('Arial','',10);					
//S.No
				$this->Cell(10,6,"07",0,0,'C',false);				
//gap
					$this->Cell(3,13);			
					$current_y =  $ystartpos ;  //52
					$current_x = $this->GetX();	
					...
					$this->SetFont('Arial','B',10);							
//Descriptor Heading
					$this->Write($descriptorFont, "Effective Communication: ");
					$this->SetFont('Arial','',10);							
//Descriptor Text
					$this->Write($descriptorFont, "$rows[1]");
					//        $this->SetLeftMargin();				
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query(" select assessment_category_type, remarks, grade  from cce_rc_section_2A_marks_det_v
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('Empathy') ");
				$rows = mysql_fetch_array($resultg1);
				
				$this->SetFont('Arial','',10);					
//S.No
				$this->Cell(10,6,"08",0,0,'C',false);				
//gap
					$this->Cell(3,13);			
					$current_y =  $ystartpos ;  //52
					$current_x = $this->GetX();	
					...
					$this->SetFont('Arial','B',10);							
//Descriptor Heading
					$this->Write($descriptorFont, "Empathy: ");
					$this->SetFont('Arial','',10);							
//Descriptor Text
					$this->Write($descriptorFont, "$rows[1]");
					//        $this->SetLeftMargin();				
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query(" select assessment_category_type, remarks, grade  from cce_rc_section_2A_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('Managing Emotions') ");
				$rows = mysql_fetch_array($resultg1);
				
				$this->SetFont('Arial','',10);					
//S.No
				$this->Cell(10,6,"09",0,0,'C',false);				
//gap
					$this->Cell(3,13);			
					$current_y =  $ystartpos ;  //52
					$current_x = $this->GetX();	
					...
					$this->SetFont('Arial','B',10);							
//Descriptor Heading
					$this->Write($descriptorFont, "Managing Emotions: ");
					$this->SetFont('Arial','',10);							
//Descriptor Text
					$this->Write($descriptorFont, "$rows[1]");
					//        $this->SetLeftMargin();				
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query(" select assessment_category_type, remarks, grade  from cce_rc_section_2A_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('Dealing with Stress') ");
				$rows = mysql_fetch_array($resultg1);
				
				$this->SetFont('Arial','',10);					
//S.No
				$this->Cell(10,6,"10",0,0,'C',false);				
//gap
					$this->Cell(3,13);			
					$current_y =  $ystartpos ;  //52
					$current_x = $this->GetX();	
					...
					$this->SetFont('Arial','B',10);							
//Descriptor Heading
					$this->Write($descriptorFont, "Dealing with Stress: ");
					$this->SetFont('Arial','',10);							
//Descriptor Text
					$this->Write($descriptorFont, "$rows[1]");
					//        $this->SetLeftMargin();				
...
/*		
		function page3_2A_setFooter () {
			$this->SetXY(10 , 271);
			$this->SetFont('Arial','',12);
			$this->Write(5,"*Descriptor Indicators are statements used to describe each learner");
//			$this->Ln(1); 
		
		}
*/

		function page4_2B_section($accountstudentid) {
			$adjustment = 0 ;		
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				...
				$data = array();
				$resultg1 = mysql_query(" select assessment_category_type, remarks, grade  from cce_rc_section_2B_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('WORK EDUCATION') ");
				$rows = mysql_fetch_array($resultg1);
...
//Grade			
		...
		function page4_2C_section($accountstudentid) {
			$adjustment = 14 + 5;
...
//Descriptor Text
		...
		function page4_2D_Border() {
			...
			$yStartPos = $ystartpos;
//		$yEndPos = 274;
//			$yEndPos = $yStartPos + 155 ;// // 3 sections + header
			$yEndPos = $yStartPos + 131 ;// // 3 sections + header
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				...
				$data = array();
				$resultg1 = mysql_query("select assessment_category_type, remarks, grade  from cce_rc_section_2D_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('ATTITUDE TOWARDS TEACHERS') ");
				$rows = mysql_fetch_array($resultg1);
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query("select assessment_category_type, remarks, grade  from cce_rc_section_2D_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('ATTITUDE TOWARDS SCHOOL MATES') ");
				$rows = mysql_fetch_array($resultg1);
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query("select assessment_category_type, remarks, grade  from cce_rc_section_2D_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('ATTITUDE TOWARDS SCHOOL PROGRAMMES AND ENVIRONMENT') ");
				$rows = mysql_fetch_array($resultg1);
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query("select assessment_category_type, remarks, grade  from cce_rc_section_2D_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('VALUE SYSTEMS') ");
				$rows = mysql_fetch_array($resultg1);
...
/*
			...
			// Title
			$this->Cell(5,0);
			$this->Cell(80,0,"3(A) Co-Scholastic Activities",0,1,'L', false);
//			$this->SetFont('Arial','I',13);	
//			$this->Cell(0,0,"( to be assessed on a 5 point scale once in a session )",0,0,'L');
			$this->SetFont('Arial','',10);	
*/			
			$this->SetFont('Arial','B',17);
					...
					$this->SetX(5);
//Descriptor Heading
					$this->Write($descriptorFont, "3(A) Co-Scholastic Activities ");
					$this->SetFont('Arial','',12);	
...
//		$yEndPos = $yStartPos + 76 ;// // 3 sections + header
		$yEndPos = $yStartPos + 88 ;// // 3 sections + header
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				...
				$data = array();
				$resultg1 = mysql_query("select assessment_category_type, remarks, grade  from cce_rc_section_3A_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('LITERARY and CREATIVE SKILLS')");
				$rows = mysql_fetch_array($resultg1);
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query("select assessment_category_type, remarks, grade  from cce_rc_section_3A_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('Scientific Skills') ");
				$rows = mysql_fetch_array($resultg1);
...
//Descriptor Heading
					$this->Write($descriptorFont, "3(B) Health and Physical Education ");
					$this->SetFont('Arial','',12);	
					$this->Write($descriptorFont, " (Any two to be assessed)");
			$this->Ln(1);					
...
// descriptors
		...
		function page5_3B_InternalBorder($accountstudentid) {
			$adjustment = 1 ;		
			$ystartpos = $this->GetY() + $adjustment;
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				...
				$data = array();
				$resultg1 = mysql_query("select assessment_category_type, remarks, grade  from cce_rc_section_3B_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('Sports/Indigenous Sports') ");
				$rows = mysql_fetch_array($resultg1);
...
//		mysql_select_db('newonli1_demodb1', $mysql);
				$data = array();
				$resultg1 = mysql_query("select assessment_category_type, remarks, grade  from cce_rc_section_3B_marks_det_v 
				where account_student_map_id = $accountstudentid and upper(assessment_category_type) = upper('NCC/NSS') ");
				$rows = mysql_fetch_array($resultg1);
...
$adjustment = 50 + 15;
		...
		function page8_Section1_InternalBorder() {
			$adjustment = 50  ;		
			$ystartpos = 25 + $adjustment; // 42

			
			$xborderstartpos =35;
			$xborderendpos = 173;
			$yStartPos = $ystartpos; // $ystartpos + $adjustment;
//		$yEndPos = 274;
			$yEndPos = 98 + $adjustment;// // 3 sections + header
...
//			$ystartpos = $adjustment; // 42
			...
			$xborderstartpos = 35;
			$yborderstartpos = 25 + $adjustment ;

			$xborderendpos = 173;
			$yborderendpos = 98 + $adjustment;
...
//gap
		...
		function page8_Section2_InternalBorder() {
			...
			$yStartPos = $ystartpos;
//		$yEndPos = 274;
			$yEndPos = 157 + $adjustment;// // 3 sections + header
...
//			$ystartpos = $adjustment; // 42
			...
			$xborderstartpos = 35;
			$yborderstartpos = 112 + $adjustment;

			$xborderendpos = 173;
			$yborderendpos = 157 +$adjustment;
...
//gap
		...
		function page8_Section3_InternalBorder() {
			...
			$yStartPos = $ystartpos;
//		$yEndPos = 274;
			$yEndPos = 177 + $adjustment ;// // 3 sections + header
